...
4. Querying more than 1000 indicators at once often returned a timeout error, so I decided to proceed by iterating deletion of 1000 indicators. I've added a `$NumberOfIterations` variable at the beginning of the script and set its initial value to 30. You can change this value to control the number of loop iterations.
